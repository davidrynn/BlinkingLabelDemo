...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/davidrynn/BlinkingLabelDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'davidrynn' => 'davidrynn@gmail.com' }
  s.source           = { :git => 'https://github.com/davidrynn/BlinkingLabelDemo.git', :tag => s.version.to_s }
